...
public class MarcaController {
  ...
  //  public ResponseEntity<List<Condutor>> findByAtivo(){
    ...
    public ResponseEntity<?> inserir(
        ...
        return ResponseEntity.ok().body("Brand registered successfully!");
    }
    @PutMapping("/{id}")
    ...
    public ResponseEntity<?> deletar(
        ...
        if (condutor.isAtivo()) {
            ...
            return ResponseEntity.badRequest().body("The brand is linked to a transaction and cannot be deleted.");
        }
